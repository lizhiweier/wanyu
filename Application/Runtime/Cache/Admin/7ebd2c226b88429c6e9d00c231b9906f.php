...
<article class="page-container">
	<form class="form form-horizontal" action="/index.php/Admin/Catecont/cate_cont/id/23" method="post" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"></label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<script name="con_content" id="editor" type="text/plain" style="width:100%;height:400px;"></script> 
			</div>
		</div>
		<div class="row cl">
