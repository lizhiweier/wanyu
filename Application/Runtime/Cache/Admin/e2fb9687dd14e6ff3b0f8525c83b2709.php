...
<div class="page-container">
	<form action="/index.php/Admin/Category/cate_add" method="post" name="form1" class="form form-horizontal" id="" enctype="multipart/form-data">
			...
			<div class="tabCon">
					...
					<div class="formControls col-xs-8 col-sm-9">
						...
						<select class="select" id="sel_Sub" name="cate_pid" onchange="SetSubID(this);">
							...
							<?php foreach ($data as $k => $v): ?>
								<option value="<?php echo $v['cate_id']; ?>"><?php echo str_repeat('├ ',($v['level']+1)*1); echo $v['cate_name']; ?></option>
							<?php endforeach; ?>
						</select>
						</span>
					</div>
					...
					<label class="form-label col-xs-4 col-sm-3">
						...
						<select class="select" id="sel_Sub" name="cate_list_tempid" onchange="SetSubID(this);">
							<?php foreach ($muban as $k => $v): ?>
								<option value="<?php echo ($v["temp_id"]); ?>"><?php echo ($v["temp_name"]); ?></option>
							<?php endforeach; ?>
						</select>
						</span>
						</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9 skin-minimal">
						<div class="check-box">
							<input type="checkbox" id="allowcomments" name="is_outlink" value="1">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="" id="" name="cate_url">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="" id="" name="cate_sort">
					</div>
					<div class="col-3">
					</div>
				</div>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" name="cate_keyword">
					</div>
					<div class="col-3">
					</div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<textarea name="cate_des" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,100)"></textarea>
