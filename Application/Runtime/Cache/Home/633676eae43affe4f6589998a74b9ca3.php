...
<!-- saved from url=(0040)http://www.pkufe.com.cn/jtgk/index.jhtml -->
...
<div class="about-page-area section-padding">
	<div class="container pt-20 pb-20">
		<div class="row">
			<div class="col-md-12">
				<div>
					<h3 class="mycolor pb-80"><?php echo ($info["cate_name"]); ?></h3>
				</div>
			</div>
		</div>
		<div class="row">
...
<!-- main JS
============================================ -->		
<script src="/Public/js/main.js"></script><a id="scrollUp" href="http://www.pkufe.com.cn/jtgk/index.jhtml#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a>
