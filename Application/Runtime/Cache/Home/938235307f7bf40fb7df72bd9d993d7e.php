<?php if (!defined('THINK_PATH')) exit(); $id = I('get.id'); $model = D('Admin/Article'); $count = $model->where("is_online='1' and cate_id=$id")->count(); $p = getpage($count,1); $list = $model->field(true)->where("is_online='1' and cate_id=$id")->order('art_id')->limit($p->firstRow, $p->listRows)->select(); ?>
<!DOCTYPE html>
<!-- saved from url=(0040)http://www.pkufe.com.cn/jyzx/index.jhtml -->
...
.flex-direction-nav a {
	...
	margin: -35px 0 0;
	display: block;
	background: url(/r/cms/www/pkufe2018/img/slide/ad_ctr.png) no-repeat;
	position: absolute;
	top: 50%;
	z-index: 10;
	cursor: pointer;
...
.flex-control-paging li a {
	background: url(/r/cms/www/pkufe2018/img/slide/dot.png) no-repeat 0 -16px;
	display: block;
	height: 16px;
	overflow: hidden;
	text-indent: -99em;
...
<div class="as-mainwrapper">
	...
	<div class="bg-white">
		...
		<!--End of Header Area-->		<!--Breadcrumb Banner Area Start-->
		...
		<div class="about-page-area section-padding" style="background-color: #f5f5f5;padding-top: 0px;">
...
<!--End of Header Area-->
			<div class="container">
				<div class="row">
					...
					<div style="box-sizing: border-box;padding: 0 10px 20px 10px;">
						<div style="padding: 30px 30px 16px; background-color: #fff; box-shadow: 0 0 5px rgba(0,0,0,.08); margin: 5px auto; border-bottom: #ddd 1px solid;">
							<a href="/index.php/Home/Article/article_show/id/<?php echo ($v["art_id"]); ?>"><h1 style="font-family: 微软雅黑, SimSun; font-size: 22px; line-height: 2em; letter-spacing: 0.05em;"><?php echo ($v["art_name"]); ?></h1></a>
							<p style="font-family: 微软雅黑, SimSun; font-size: 15px; line-height: 2em; letter-spacing: 0.05em; text-indent: 2em; margin: 15px;"><?php echo ($v["art_des"]); ?></p>
						</div>
					</div>
					<?php endforeach; ?>
				</div>
				<div style="text-align: center; font-family: 微软雅黑, SimSun; font-size: 15px; line-height: 2em; letter-spacing: 0.05em;padding: 40px 0 20px 0;">
					<div class="pages">
						...
						<a href="http://www.pkufe.com.cn/jyzx/index.jhtml#" onclick="location.href=encodeURI(&#39;index_2.jhtml&#39;);">下一页</a> 
						<a href="http://www.pkufe.com.cn/jyzx/index.jhtml#" onclick="location.href=encodeURI(&#39;index_2.jhtml&#39;);">尾页</a>&nbsp;
...
<!-- main JS
============================================ -->		
<script src="/Public/js/main.js"></script><a id="scrollUp" href="http://www.pkufe.com.cn/jyzx/index.jhtml#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a>
