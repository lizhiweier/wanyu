...
<!-- saved from url=(0039)http://www.pkufe.com.cn/jyzx/1018.jhtml -->
...
<title><?php echo ($info["art_short_name"]); ?>_河南万豫教育集团</title>
<meta name="description" content="<?php echo ($info["art_des"]); ?>">
<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=0">

<style>.zhengwen, .zhengwen p,  .zhengwen p span{
    font-family: 微软雅黑, SimSun !important;
...
.zhengwen img, .zhengwen p img,  .zhengwen p span img{
    padding: 10px 0 !important;
    max-width: 80% !important;
    margin-left: -2em;
}
.zhengwen h1, .zhengwen h2, .zhengwen h3, .zhengwen h4, .zhengwen h5, .zhengwen h6, .zhengwen h1 span, .zhengwen h2 span, .zhengwen h3 span, .zhengwen h4 span, .zhengwen h5 span, .zhengwen h6 span{
    font-weight: bold;
}
</style>
...
<meta content="<?php echo ($info["art_keyword"]); ?>" http-equiv="description">
<script src="/Public/js/jquery.js" type="text/javascript"></script>
<script src="/Public/js/front.js" type="text/javascript"></script>
<script type="text/javascript">
$(function() {
Cms.checkPerm("","1018");
Cms.collectCsi("","collectCsiDiv","collect_csi","1018");
Cms.attachment("","1018","0","attach");
Cms.viewCount("","1018");
...
if($refresh){ ?>
    ...
    ajax.open('GET','/index.php/Home/Article/tongji/id/<?php echo ($info["art_id"]); ?>',true);  
    ajax.send();  
<?php
} ?>
</script>
...
<div class="as-mainwrapper">
	...
	<div class="bg-white">
							...
							<div class="breadcrumb-bar">
								<ul class="breadcrumb text-center">
									<li><a href="http://www.pkufe.com.cn/">首页</a></li>
									 <li><?php echo ($info["cate_pname"]); ?></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<!--End of Breadcrumb Banner Area-->		<!--About Page Area Start-->
					...
					<div class="col-md-12">
						<div class="section-title-wrapper">
							<div class="section-title">
								<h3 style="font-size: 22px;"><?php echo ($info["art_name"]); ?></h3>
								<p>&nbsp;</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="about-text-container">
							...
							发布人：<?php echo ($info["art_author"]); ?>&nbsp;&nbsp;
							来源：<?php echo ($info["art_source"]); ?>&nbsp;&nbsp;
							发布日期：<?php echo ($info["art_time"]); ?>&nbsp;&nbsp;
							阅读次数：<?php echo ($info["art_viewed"]); ?>
							</p>
							<p><br></p>
							<?php echo ($info["art_text"]); ?>
							</div>
						</div>
					</div>
				</div>
...
<!-- main JS
============================================ -->		
<script src="/Public/js/main.js"></script><a id="scrollUp" href="http://www.pkufe.com.cn/jyzx/1018.jhtml#top" style="position: fixed; z-index: 2147483647; display: none;"><i class="fa fa-angle-up"></i></a>
